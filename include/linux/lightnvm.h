...
struct nvm_rq {
    ...
    /* Coperd: differentiate different read I/Os */
    unsigned int type;
    /* Coperd: mark whether we return ebusy for this request */
    unsigned int ebusy; 
    ktime_t stime;
    s64 tlat_us; /* Coperd: measured real latency of this request */
    s64 plat_us; /* Coperd: predicted latency of this request */
    int id;
    int *lun_dist;
    struct list_head list;
};
